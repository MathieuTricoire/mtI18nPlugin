...
<?php elseif ('_change_language' == $name): ?>
  <?php echo $this->addCredentialCondition(
'[?php foreach ($helper->getLanguages() as $language): ?]
  [?php echo $helper->linkToChangeLanguage($'.$this->getSingularName().', $language) ?]
[?php endforeach; ?]'
, $params) ?>
